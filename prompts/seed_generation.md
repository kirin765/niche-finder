You are generating durable seed categories for discovering Korean micro SaaS opportunities.
...
- `description`: one-sentence explanation of the operational area
- `rationale`: why this seed is promising for micro SaaS research

Optimize for practical breadth across different industries rather than many near-duplicates.
