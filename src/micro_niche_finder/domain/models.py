...
class Feature(Base):
    ...
    competitive_whitespace_score: Mapped[float] = mapped_column(Float, nullable=False, default=0.6)
    keyword_difficulty_score: Mapped[float] = mapped_column(Float, nullable=False, default=0.5)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utcnow, nullable=False)
