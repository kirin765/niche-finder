...
class Settings(BaseSettings):
    ...
    codex_candidate_model: str | None = Field(default=None, alias="CODEX_CANDIDATE_MODEL")
    codex_final_model: str | None = Field(default=None, alias="CODEX_FINAL_MODEL")
    ...
    naver_ads_base_url: str = Field(default="https://api.searchad.naver.com/keywordstool", alias="NAVER_ADS_BASE_URL")
